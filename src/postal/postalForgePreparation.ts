...
export const POSTAL_FORGE_WEAK_POSTAL_PREPARATION_COUNTRIES: PostalForgePreparationTarget[] = [
  ...
  weakPostal('TZ', 'Tanzania', 'Africa', -6.369, 34.8888, 67_000_000, 945_087, 31, 'mixed', '^\\d{5}$', ['11101'], 'TCRA specifies a five-digit numeric national postcode format; use format validation only while mapping scope, redistribution rights, and freshness remain under review.'),
  ...
  weakPostal('UG', 'Uganda', 'Africa', 1.3733, 32.2903, 49_000_000, 241_038, 170, 'mixed', undefined, undefined, 'Posta Uganda exposes postal-address services, but no authority-published national postcode regex is verified here. Do not format-validate, query, or autofill until format, mapping, rights, and update evidence are recorded.'),
  ...
  weakPostal('CD', 'DR Congo', 'Africa', -4.0383, 21.7587, 102_000_000, 2_344_858, 145, 'mixed', '^\\d{4,5}$', ['1000'], 'Use province/territory/city hierarchy, humanitarian review, and AGID cells as supplemental identifiers.'),
