...
export const OFFICIAL_POSTAL_SOURCE_CATALOG: OfficialPostalSourceProfile[] = [
  ...
  },
  {
    id: 'usps-web-tools',
    countryCodes: ['US'],
    label: 'USPS Web Tools ZIP Code and address APIs',
    authority: 'postal-operator',
    trustTier: 'authoritative',
    availability: 'auth-required-api',
    depth: 'delivery-point',
    url: 'https://www.usps.com/business/web-tools-apis/',
    sourceNames: ['usps', 'usps web tools', 'zip code lookup api', 'address information api'],
    openSourceIds: ['usps-web-tools'],
    requiresCredential: true,
    notes: ['Official USPS API path; credentials and terms are required.'],
  },
  {
