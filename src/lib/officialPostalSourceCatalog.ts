...
export const OFFICIAL_POSTAL_SOURCE_CATALOG: OfficialPostalSourceProfile[] = [
  ...
  },
  {
    id: 'estonia-in-ads',
    countryCodes: ['EE'],
    label: 'Estonian Address Data System In-ADS',
    authority: 'government',
    trustTier: 'authoritative',
    availability: 'public-api',
    depth: 'address',
    url: 'https://geoportaal.maaamet.ee/eng/services/in-ads-p660.html',
    sourceNames: ['in-ads', 'ads', 'estonian address data system', 'maa-amet', 'estonia address data'],
    openSourceIds: ['estonia-in-ads', 'maa-amet-ads'],
    requiresCredential: false,
    notes: [
      'Official Estonian address search API for normalized addresses from the national Address Data System.',
      'Use as address and postcode-adjacent official evidence; keep carrier delivery availability as a separate gate.',
    ],
  },
  {
