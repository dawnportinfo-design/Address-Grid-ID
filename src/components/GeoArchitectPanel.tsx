      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed inset-x-4 bottom-4 top-20 bg-white rounded-[2rem] shadow-2xl z-[90] overflow-hidden flex flex-col border border-slate-200 lg:left-auto lg:right-4 lg:w-[480px] lg:top-4"
          >
            {/* Header */}
            ...
            <div className="p-6 border-t border-slate-100 flex gap-3">
              ...
              <button 
                ...
                className="flex-[2] py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-black text-xs uppercase tracking-widest transition-all shadow-xl shadow-purple-100 flex items-center justify-center gap-2"
              >
